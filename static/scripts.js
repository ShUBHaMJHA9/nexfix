document.addEventListener('DOMContentLoaded', () => {
    ...
    const ui = {
        ...
        controls: document.querySelector('#videoPlayer')?.querySelector('.controls'),
        fastRewind: document.querySelector('#videoPlayer')?.querySelector('.fast-rewind'),
        fastForward: document.querySelector('#videoPlayer')?.querySelector('.fast-forward'),
        volume: document.querySelector('#videoPlayer')?.querySelector('.volume'),
        volumeSlider: document.querySelector('#videoPlayer')?.querySelector('.volume-slider'),
        volumePercentage: document.querySelector('#videoPlayer')?.querySelector('.volume-percentage'),
        fullscreen: document.querySelector('#videoPlayer')?.querySelector('.fullscreen'),
        pictureInPicture: document.querySelector('#videoPlayer')?.querySelector('.picture_in_picture'),
        theaterMode: document.querySelector('#videoPlayer')?.querySelector('.theater-mode'),
        progressArea: document.getElementById('progressArea'),
        progressBar: document.querySelector('#videoPlayer')?.querySelector('.progress-bar'),
        bufferedBar: document.querySelector('#videoPlayer')?.querySelector('.bufferedBar'),
        current: document.querySelector('#videoPlayer')?.querySelector('.current'),
        totalDuration: document.querySelector('#videoPlayer')?.querySelector('.duration'),
        autoPlay: document.querySelector('#videoPlayer')?.querySelector('.auto-play'),
        settingsBtn: document.querySelector('#videoPlayer')?.querySelector('.settingsBtn'),
        captionsBtn: document.querySelector('#videoPlayer')?.querySelector('.captionsBtn'),
        ...
        videoTitle: document.getElementById('movie-title'), // Mapped to movie-title
        videoDescription: document.getElementById('movie-description'), // Mapped to movie-description
        ...
        annotationOverlay: document.querySelector('#videoPlayer')?.querySelector('.annotation-overlay'),
        contextMenu: document.querySelector('#videoPlayer')?.querySelector('.context-menu'),
        keyboardShortcutsOverlay: document.getElementById('keyboardShortcutsOverlay'),
        errorOverlay: document.querySelector('#videoPlayer')?.querySelector('.error-overlay'),
        loadingSpinner: document.querySelector('#videoPlayer')?.querySelector('.loading-spinner'),
    ...
    const setupVideoJsPlayer = async (source, thumbnail, subtitles, audio_options, meta, isLive, videoId) => {
        ...
        if (ui.qualityBadge) ui.qualityBadge.textContent = source.quality || 'Auto';
            ...
            player.on('error', () => {
                ...
                displayError('Please click play to start the video');
                ui.playButtonOverlay.classList.remove('hidden');
            });
            ...
            ui.playButton.addEventListener('click', async () => {
                try {
                    ...
                    ui.playButtonOverlay.classList.add('hidden');
                } catch (err) {
                    console.error('Playback failed:', err);
                    displayError(`Failed to start: ${err.message || 'Unknown error'}`);
                }
            });
